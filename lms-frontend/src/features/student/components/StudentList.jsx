        ...
        <div>
            ...
            <div className="card">
                <DataTable showGridlines stripedRows value={studentsInCourse} tableStyle={{ minWidth: '50rem' }} paginator
                    rows={10} emptyMessage="No students found"
                >
                    <Column
                        header="No."
                        style={{ width: '5%' }}
                    ...
                    />
                    <Column field="code" header="Student ID" style={{ width: '10%' }}></Column>
                ...
                <Button className='ml-2'
                    label="Attendance" onClick={() => navigate(`/teacher/courses/${courseId}/attendance`)} />
            </div>
        </div>
    );
}
