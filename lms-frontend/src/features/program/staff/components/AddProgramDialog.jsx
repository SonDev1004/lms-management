...
export default function AddProgramDialog({ visible, onClose, onSave }) {
    ...
    const [form, setForm] = useState({
        name: "", level: "A2–B1", durationWeeks: 12, fee: 0,
        totalCourses: 0, activeCourses: 0, status: "active",
    });
    ...
    useEffect(() => {
        if (!visible) return;
        setForm({ name: "", level: "A2–B1", durationWeeks: 12, fee: 0, totalCourses: 0, activeCourses: 0, status: "active" });
                ...
                <section className="dlg-sec">
                    ...
                    <div className="frm-grid">
                        <div className="frm-field" style={{ gridColumn: "1 / -1" }}>
                            <label htmlFor="pg-name">Program name <span className="req">*</span></label>
                            <InputText
                                id="pg-name"
                                ref={firstInputRef}
                                value={form.name}
                        ...
                        <div className="frm-field">
                            ...
                            <Dropdown inputId="pg-status" value={form.status} options={statusOpts}
                                      onChange={(e) => setForm(s => ({ ...s, status: e.value }))}/>
                        </div>

                        <div className="frm-field">
                            <label htmlFor="pg-level">Level (CEFR)</label>
                            <Dropdown inputId="pg-level" value={form.level} options={levelOpts}
                    ...
                    <div className="frm-grid">
                        <div className="frm-field">
                            ...
                            <InputNumber
                                ...
                                onValueChange={(e) => setForm(s => ({ ...s, durationWeeks: e.value ?? 0 }))}
                                showButtons
                        ...
                        <div className="frm-field">
                            ...
                            />
                            <div className="hint">Học phí toàn khóa, chưa gồm tài liệu.</div>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="frm-grid">
                        <div className="frm-field">
                            ...
                            <InputNumber
                                ...
                                onValueChange={(e) => setForm(s => ({ ...s, totalCourses: e.value ?? 0 }))}
                                showButtons
                                buttonLayout="vertical"
                                incrementButtonIcon="pi pi-chevron-up"
                                decrementButtonIcon="pi pi-chevron-down"
                        ...
                        <div className="frm-field">
                            ...
                            <InputNumber
                                ...
                                onValueChange={(e) => setForm(s => ({ ...s, activeCourses: e.value ?? 0 }))}
                                showButtons
                                buttonLayout="vertical"
                                incrementButtonIcon="pi pi-chevron-up"
                                decrementButtonIcon="pi pi-chevron-down"
                                ...
                                decrementButtonClassName="apd-step"
                                min={0}
                                className={form.activeCourses > form.totalCourses ? "p-invalid" : ""}
                            />
                            {form.activeCourses > form.totalCourses && (
                                <div className="error">Active không thể lớn hơn Total.</div>
                            )}
                        </div>
                    </div>
                </section>
