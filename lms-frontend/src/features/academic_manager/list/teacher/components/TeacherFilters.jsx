            ...
            <div className="grid align-items-center search-grid">
                ...
                <div className="col-6 md:col-2">
                    <Dropdown
                        className="w-full"
                        value={value.dept}
                        onChange={(e) => onChange.setDept(e.value)}
                        options={departments}
                        optionLabel="label"
                        optionValue="value"
                ...
                <div className="col-6 md:col-2">
                    <Dropdown
                        className="w-full"
                        value={value.subject}
                        onChange={(e) => onChange.setSubject(e.value)}
                        options={subjects}
                        placeholder="Subject"
                        showClear
                    />
                ...
                <div className="col-6 md:col-2">
                    <Dropdown
                        className="w-full"
                        value={value.emp}
                        onChange={(e) => onChange.setEmp(e.value)}
                        options={empTypes}
                        optionLabel="label"
                        optionValue="value"
                ...
                <div className="col-12 md:col-12 flex md:justify-content-end export-col">
