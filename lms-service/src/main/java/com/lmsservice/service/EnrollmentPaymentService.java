...
public class EnrollmentPaymentService {
    ...
    public PendingEnrollment createPending(Long userId, Long programId, Long subjectId, BigDecimal amount, BigDecimal totalFee, String txnRef) {
    ...
    public Enrollment finalizeSuccessfulPayment(String txnRef, Map<String, String> vnpParams) {
        ...
        // update role from GUEST -> STUDENT if necessary
